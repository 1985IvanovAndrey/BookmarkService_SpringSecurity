...
<div class="container">
    ...
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <h2><font color="#adff2f"> Page second</font> ${pageContext.request.userPrincipal.name} | <a onclick="document.forms['logoutForm'].submit()">Logout</a></h2>
    </c:if>
    <form action="/third">
       <h4> <input class=" btn btn-outline-primary btn-sm" type="submit" value="Page 3"></h4>
    </form>
    <form action="/users">
